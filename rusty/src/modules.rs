...
pub fn execute_module(lib: &Library, config: HashMap<String, String>, data: HashMap<String, String>) -> (String, HashMap<String, String>, String) {
    unsafe{
        // Answer -> (String, HashMap<String, String>, String) -> StatusCode, Headers, Body
        let func: Symbol<unsafe extern "C" fn(HashMap<String, String>, HashMap<String, String>) -> (String, HashMap<String, String>, String)> = lib.get(b"execute").expect("Failed to load function");
